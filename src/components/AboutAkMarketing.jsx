      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            About <span className="text-cyan-400">AetherMark</span>
          </h1>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-300">
              AetherMark is a leading digital marketing consultancy that
              specializes in developing innovative online marketing strategies
              through advanced technology integration and data-driven
              excellence.
            </p>
          </motion.div>
...
export default AboutAetherMark;
