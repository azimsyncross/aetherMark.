...
const content = {
  hero: {
    title: "Ignite Your Brand's Growth with AetherMark",
    subtitle:
      "Drive impactful results with targeted digital advertising, SEO strategies that elevate your site, and ASO that makes your app stand out. Let AetherMark propel your brand across Google, Facebook, Instagram, and beyond!",
