          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-300 mt-6 leading-relaxed">
                Robert brings a wealth of leadership experience and a passion
                for digital transformation. His strategic approach and
                commitment to client success continue to drive our mission
                forward.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-400">+1 640-272-0406</span>
                </li>
                <li className="flex items-start">
                  <MapPin className="w-5 h-5 text-cyan-400 mt-1 mr-3 flex-shrink-0" />
                  <span className="text-gray-400">
                    Pine Place 32, Farmington, Minnesota 55024, United States
                  </span>
                </li>
              </ul>
            </div>
