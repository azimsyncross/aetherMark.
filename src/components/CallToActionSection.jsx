          ...
          <div className="space-y-8">
            ...
            >
              ...
              <span className="block mt-2 text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-blue-400">
                With AetherMark&apos;s Expertise, We’ll Drive Your Growth.
              </span>
            </motion.h2>
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              AetherMark specializes in optimizing online performance,
              increasing user engagement, and driving sustainable growth across
              multiple digital channels. Whether it’s through targeted social
              media advertising, expert SEO strategies, app store optimization,
              or high-quality content creation, our tailored solutions are
              designed to boost your visibility, attract users, and maximize
              your ROI.
            </motion.p>
