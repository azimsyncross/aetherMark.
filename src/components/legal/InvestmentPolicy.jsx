...
// Assuming you have a PageTitle component like the one created before

// Helper component for individual policy sections to keep the main component clean
...
// The main component for the Investment Policy page
const InvestmentPolicy = () => {
  // Data for the policy sections, making it easy to manage and render
  const policyData = [
    {
      number: 1,
      title: "General Investment Framework",
      description:
        "At AetherMark, we are committed to delivering exceptional service quality and ensuring client satisfaction. Our investment policy is designed to be fair and transparent while recognizing the specialized nature of strategic digital marketing services.",
      points: [
