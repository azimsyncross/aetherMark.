...
const WhyUs = () => {
  const content = {
    header: {
      ...
      subtitle:
        "Discover why top brands trust AetherMark for their SEO, ASO, and advertising needs",
    },
    slides: [
      {
        ...
        content:
          "AetherMark helps you create high-impact ad campaigns across YouTube, Facebook, Instagram, and TikTok, engaging your target audience and driving conversions with tailored digital advertising strategies.",
      ...
      },
      {
        ...
        content:
          "With AetherMark&apos;s ASO strategies, we ensure your app ranks higher in app stores, optimizing listings, keywords, and visuals to increase downloads and user engagement.",
      ...
      },
      {
        ...
        content:
          "Whether it&apos;s improving SEO for your website or optimizing ASO for your app, AetherMark offers personalized strategies designed for sustainable growth and long-term success.",
